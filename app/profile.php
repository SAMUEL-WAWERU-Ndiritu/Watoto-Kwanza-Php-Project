...
<head>
 ...
 <title>Profile | Watato Kwanza</title>
          ...
          <form action="" autocomplete="off" id="profile-form" class="form-horiontal" method="post">
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <select class="form-control editable" id="state" value="<?php echo $state; ?>" disabled>
                  ...
                  <option value="Abia">Muranga</option>
                  <option value="Adamawa">Nairobi</option>
                  <option value="AkwaIbom">Machakos</option>
                  <option value="Anambra">Embu</option>
                  <option value="Bauchi">Kirinyaga</option>
                  <option value="Bayelsa">Mombasa</option>
                  <option value="Benue">Nyandarua</option>
                  <option value="Borno">Laikipia</option>
                  <option value="Cross River">Bomet</option>
                  
                </select>
                <span class="invalid-feedback">Please select your county of residence</span>
              </div>

              <div class="col-md-6 mb-3">
                <label>School</label>
                <input type="text" id="address" class="form-control editable" value="<?php echo $address; ?>" placeholder="Enter your address" disabled>
                <span class="invalid-feedback">Please enter your School</span>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <span class="invalid-feedback">Please enter your class</span>
              </div>
